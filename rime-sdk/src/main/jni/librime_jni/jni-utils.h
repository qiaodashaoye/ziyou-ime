...
class GlobalRefSingleton {
 public:
  ...
  explicit GlobalRefSingleton(JavaVM *jvm_) : jvm(jvm_) {
    ...
    Rime = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/ziyou/ime/core/RimeNative")));
    ...
    MenuProto = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/ziyou/ime/core/MenuProto")));
    MenuProtoInit = env->GetMethodID(
        MenuProto, "<init>",
        "(IIZI[Lcom/ziyou/ime/core/CandidateProto;Ljava/lang/"
        "String;[Ljava/lang/String;)V");

    StatusProto = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/ziyou/ime/core/StatusProto")));
    StatusProtoInit =
    ...
    SchemaListItem = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/ziyou/ime/core/SchemaItem")));
    ...
    KeyEvent = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("com/ziyou/ime/core/RimeKeyEvent")));
    KeyEventInit =
