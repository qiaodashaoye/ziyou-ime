...
Java_com_ziyou_ime_core_RimeConfig_openRimeConfig(JNIEnv* env,
                                                           jclass /* thiz */,
                                                           jstring config_id) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_ziyou_ime_core_RimeConfig_openRimeUserConfig(
    JNIEnv* env, jclass /* thiz */, jstring config_id) {
  auto api = rime_get_api();
  auto config = new RimeConfig;
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_ziyou_ime_core_RimeConfig_openRimeSchema(JNIEnv* env,
                                                           jclass /* thiz */,
                                                           jstring schema_id) {
  auto api = rime_get_api();
  auto config = new RimeConfig;
...
Java_com_ziyou_ime_core_RimeConfig_getRimeConfigInt(JNIEnv* env,
                                                             jclass /* thiz */,
                                                             jlong peer,
                                                             jstring key) {
  auto api = rime_get_api();
...
extern "C" JNIEXPORT void JNICALL
Java_com_ziyou_ime_core_RimeConfig_setRimeConfigBool(JNIEnv* env,
                                                              jclass /* thiz */,
                                                              jlong peer,
                                                              jstring key,
                                                              jboolean value) {
