...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun buildSettingsView(): View {
        ...
        personaItem.setOnClickListener {
            startActivity(Intent(this, PersonaManagerActivity::class.java))
        }
    ...
    // ===== AI 人设管理（独立页面 [PersonaManagerActivity]：查看/切换/编辑/删除
    //       人设及其知识库绑定关系，入口即上方「AI 人设」设置项） =====
    ...
    private fun refreshDisplay() {
        ...
        if (::knowledgeValueText.isInitialized) {
            ...
            knowledgeValueText.text = "已导入 $count 条（在人设管理中绑定）"
        }
